                ...
                <li class="nav-item">
                    ...
                    <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                        ...
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="/utilities-color">Data buku</a>
                            <a class="collapse-item" href="/utilities-border">Data Judul</a>
                            <a class="collapse-item" href="/utilities-animation">Data Tulisan</a>
                            <a class="collapse-item" href="/utilities-other">Data Kategori</a>
                        </div>
                    </div>
                </li>
